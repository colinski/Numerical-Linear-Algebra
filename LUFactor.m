...
for i=1:m-1
    ...
    for j=i+1:m
        %calculate the pivoting factor and store it in the lower triangaluar portion of A
        A(j,i)=A(j,i)/A(i,i);
        for k=i+1:m
...
%extract the lower and upper trinagluar portions of A
L = tril(A,-1) + eye(m);
U = triu(A);
end
